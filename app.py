...
lineaccesstoken = 'L4BGVZsh0PG+ydCXYxGV36fo6J4hVzLeir7XAe9CEneLRp3Vlj6mE8FAIDDTBBOYdwFFenrxFx4sektSErdRbVDzqCYp/5au5uyRi4kR7G0vsONw73mEWG8UboyyqSQneeP+75hxAc7wotLV5CT/uwdB04t89/1O/w1cDnyilFU='
...
def event_handle(event):
    ...
    if msgType == "text":
        ...
        if (msg == "สวัสดี") :
            ...
            replyObj = TextSendMessage(text="ไม่ไปมันร้อน")
        elif (msg == "ตอบหน่อย") :
            replyObj = TextSendMessage(text="ไม่ตอบ")
            line_bot_api.reply_message(rtoken, replyObj)
        else :
            headers = request.headers
            json_headers = ({k:v for k, v in headers.items()})
            json_headers.update({'Host':'bots.dialogflow.com'})
            url = "https://dialogflow.cloud.google.com/v1/integrations/line/webhook/f18e3566-3146-462c-9d22-79346b5480ca"
